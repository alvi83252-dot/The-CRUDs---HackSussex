  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#E6ECD0] to-[#C7D2A4] px-5 py-8">
      ...
      <div className="max-w-md mx-auto mt-10 mb-6">
        <button
          onClick={() => router.push("/")}
          className="w-full px-6 py-4 bg-gradient-to-r from-[#4A4F1E] to-[#5A5F2E] text-white font-semibold rounded-2xl transition-all hover:shadow-lg hover:scale-105 flex items-center justify-center gap-2"
        >
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path d="M3 10l8-8 8 8M4 9v8a1 1 0 001 1h2v-4h4v4h2a1 1 0 001-1V9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
          Back to Map
        </button>
      </div>
